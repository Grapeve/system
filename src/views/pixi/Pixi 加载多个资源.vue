...
PIXI.Assets.add('jian', './src/assets/textures/jian.png')
PIXI.Assets.add('man', './src/assets/textures/man.png')
PIXI.Assets.add('mujian', './src/assets/textures/mujian.png')

const initRender = async () => {
  const container = new PIXI.Container()
  const textures = await PIXI.Assets.load(['jian', 'man', 'mujian'])
  const sprite = new PIXI.Sprite(textures.jian)
  container.addChild(sprite)
  const manSprite = new PIXI.Sprite(textures.man)
